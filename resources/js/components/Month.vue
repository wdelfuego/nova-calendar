...
<template>
    ...
    <div style="width:100%;overflow:scroll">
        <Card class="flex flex-col items-center justify-center dark:bg-gray-800"
            ...
            <div class="nova-calendar month-view noselect" v-if="title.length">

                <div :class="{ 'shouldShowWeekNumbers': shouldShowWeekNumbers }">

                    <!-- week numbers column-->
                    <div v-if="shouldShowWeekNumbers" class="border-gray-200 dark:border-gray-900 dark:text-gray-300">
                    </div>
                ...
                <div class="nc-content">
                    ...
                    <!-- week wrapper -->
                    <div v-for="(week, weekIndex) in $data.weeks"
                        :class="{ 'shouldShowWeekNumbers': shouldShowWeekNumbers }">

                        <div v-if="shouldShowWeekNumbers"
                                    ...
                                    <div class="dayheader text-gray-400 noselect">
                                        ...
                                        <div class="badges">
                                            <span class="badge-bg text-gray-200" v-for="badge in day.badges">
                                                <Tooltip><template #content><span
                                                            v-html="badge.tooltip"></span></template>
